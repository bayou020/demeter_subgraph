...
import {
  ...
  RewardsClaimed,
  TokenManagerUpdated
} from "../generated/CamelotFarm/CamelotFarm"
...
export function createPoolRewardsCollectedEvent(
  recipient: Address,
  tokenId: BigInt,
  grailAmt: BigInt,
  xGrailAmt: BigInt
): PoolRewardsCollected {
  let poolRewardsCollectedEvent = changetype<PoolRewardsCollected>(
    newMockEvent()
  )

  poolRewardsCollectedEvent.parameters = new Array()

  poolRewardsCollectedEvent.parameters.push(
  ...
  poolRewardsCollectedEvent.parameters.push(
    new ethereum.EventParam(
      "grailAmt",
      ethereum.Value.fromUnsignedBigInt(grailAmt)
    )
  )
  poolRewardsCollectedEvent.parameters.push(
    new ethereum.EventParam(
      "xGrailAmt",
      ethereum.Value.fromUnsignedBigInt(xGrailAmt)
    )
  )

  return poolRewardsCollectedEvent
}
